export class DviHeatpumpCardEditor extends HTMLElement {
	...
	_buildSchema() {
		...
		this._advancedSchema = [
			...
			{ name: "pump_type", label: "Pump type (pump_type)", selector: { entity: { domain: "sensor" } } },
			...
			{ name: "cold_side_warm_temp", label: "Cold side warm temperature (cold_side_warm_temp)", selector: { entity: { domain: "sensor" } } },
			{ name: "cold_side_cold_temp", label: "Cold side cold temperature (cold_side_cold_temp)", selector: { entity: { domain: "sensor" } } },
			...
			{ name: "sumalarm", label: "Summary alarm (sumalarm)", selector: { entity: { domain: "binary_sensor" } } },
		];
	}
	...
	_autoFillFromDevice(deviceId) {
		...
		const patch = {
			...
			cold_side_warm_temp: find("sensor", "cold_side_warm"),
			cold_side_cold_temp: find("sensor", "cold_side_cold"),
			...
			sumalarm: find("binary_sensor", "sum_alarm_failure") || find("binary_sensor", "sumalarm"),
